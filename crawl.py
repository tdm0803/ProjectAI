...
for l in lit:
    arguments = {
        ...
        "limit": 20,
        "print_urls": True,
        # "output_directory":"/mnt/hdd2T/tham/projectAI/GUI/ProjectAI_Streamlit/crawl",
        # "image_directory":"/mnt/hdd2T/tham/projectAI/GUI/ProjectAI_Streamlit/crawl/images/",
        "size": "large",
    ...
    img_dir = r"/mnt/hdd2T/tham/projectAI/GUI/ProjectAI_Streamlit/crawl/downloads"
    ...
    for line in output.split("\n"):
        if line.startswith("Image URL:"):
            ...
            d=line.replace("Image URL: ", "")

            new_lines.append(d)
    print(new_lines)

    filename1= arguments.get('keywords')
    # for fn1 in filename1.split(','): 
        
    with open(img_dir + "/" + filename1+'.txt','w') as k:
